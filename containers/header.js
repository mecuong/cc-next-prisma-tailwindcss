            ...
            <nav className="bg-white shadow-lg">
                <div className="md:flex items-center justify-between py-2 px-8 md:px-12">
                    ...
                    <div className="flex flex-col md:flex-row hidden md:block -mx-2">
                        <Link href="/">
                            <a className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Home</a>
                        </Link>

                        <Link href="/about">
                            <a className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">About</a>
                        </Link>
                    </div>
                </div>
            </nav>
